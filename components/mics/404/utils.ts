...
export const generateSVGTrophy = (
  ...
  <text x="1536" y="855" text-anchor="end" class="signature-font" style="font-family: ${fontSignature};" font-size="32" fill="rgba(241,238,229,0.85)">muhfees...</text>
</svg>`;
};
