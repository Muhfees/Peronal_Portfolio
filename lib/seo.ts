  ...
  return {
    ...
    hasPart: [
      ...
      },
      {
        ...
        name: "Muhfeesur Rahman Resume PDF",
  ...
  const siteLinks = [
    {
      name: "Projects & Selected Works",
      description:
        "Explore full-stack web applications, AI tools, and open-source GitHub repositories created by Muhfeesur Rahman.",
    ...
    },
    {
      name: "Resume & Curriculum Vitae",
      description:
        "Professional background, technical skills, education, and career experience of Muhfeesur Rahman.",
      url: `${baseUrl}/resume`,
    },
    {
      name: "Direct Resume PDF",
      description:
        "Direct view and download of the official resume PDF of Muhfeesur Rahman.",
