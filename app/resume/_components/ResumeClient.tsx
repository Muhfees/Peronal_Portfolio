...
const RESUME_PATH = "/docs/muhfees_rahman_resume.pdf";
        ...
        <main className="flex-1 pt-28 sm:pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full space-y-6">
          ...
          >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <motion.a
                ...
                href={RESUME_PATH}
                download="Muhfeesur_Rahman_Resume.pdf"
          ...
          >
            <iframe
              ...
              title="Muhfeesur Rahman Resume PDF"
          ...
          <p className="text-center text-xs text-muted-foreground font-mono">
            ...
            <a
              href={RESUME_PATH}
              download="muhfees_rahman_resume.pdf"
              className="text-accent hover:underline"
            >
              download it
            </a>
